...
class FriendTest {
    ...
    @DisplayName("should equal the expense which is assigned to the friend.")
    @Test
    ...
    @DisplayName("should not equal the expense which is not assigned to friend.")
    @Test
    ...
    @DisplayName("should equal expense3 which is not assigned to friend and the expense assigned to friend where the value is same.")
    @Test
